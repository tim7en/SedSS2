...
server <- function(input, output, session) {
  ...
  dat_check <- callModule (sidebar_func, "source_check", source_input, target_input)
  ...
  multivarNormality <- callModule (multivariate_server, "multivariate_ui", correction, bracket, target_input)
  dfa <- callModule (dfa_server, "dfa_f", multivarNormality, bracket, target_input)
